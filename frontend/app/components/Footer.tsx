...
const Footer = () => {
  return (
    <footer className="bg-blue-300 flex font-serif flex-col justify-center items-center">
      <div className="bg-footer-image w-full px-4 md:px-8 py-2 flex flex-col justify-center items-center gap-4">
        ...
        <p className="text-blue-800 text-center text-sm-2 md:text-xl max-w-2xl">
      ...
      <div className="py-4">
        <p className="text-center text-blue-800 text-sm md:text-base">
          Built with ❤️ by EquitoX Team
        </p>
      </div>
    </footer>
  );
